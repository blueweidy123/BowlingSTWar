...
//            Quaternion initialRotation = Quaternion.Euler(pin.GetComponent<InitialRotation>().initialRotation);
//            Quaternion currentRotation = pin.transform.rotation;

//            // Calculate the quaternion difference
//            float rotationThreshold = limit;

//            if (Quaternion.Angle(initialRotation, currentRotation) < rotationThreshold)
//            {
//                point++;
//            }
//        }
